...
const GenerateFretboardInputSchema = z.object({
  chord: z.string().describe('The name of the chord, e.g., "C", "G7", "F#m".'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert guitarist. Generate the simplest, most common fingering for the guitar chord: "{{chord}}".
...
For example, for "Am", you would return:
- frets: [-1, 0, 2, 2, 1, 0]
- fingers: [0, 0, 2, 3, 1, 0]

For "F", a barre chord, you might return:
- frets: [1, 3, 3, 2, 1, 1]
- fingers: [1, 3, 4, 2, 1, 1]`,
});
